...
var updateBandwidthData = function() {
    ...
    console.log(player.getPlaybackVideoData());
    ...
    console.log("selectedCodecSegmentBytes:", selectedCodecSegmentBytes);
    segmentData.push({
...
if (document.readyState === "complete" || (document.readyState !== "loading" &&
    ...
    document.addEventListener("DOMContentLoaded", multicodec);
}